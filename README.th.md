...
รันโค้ด numpy บนข้อมูลที่เข้ารหัสแบบโฮโมมอร์ฟิก (homomorphic encryption)
**ผู้ควบคุมข้อมูลส่วนบุคคล** (data controller) เข้ารหัสข้อมูลและเก็บกุญแจลับไว้กับตัว
**ผู้ประมวลผลข้อมูลส่วนบุคคล** (data processor) คำนวณบนข้อมูลเข้ารหัสด้วยโค้ด
numpy ตามปกติ โดยไม่มีทางอ่านข้อมูลได้ แล้วผู้ควบคุมข้อมูลเป็นผู้ถอดรหัสผลลัพธ์
